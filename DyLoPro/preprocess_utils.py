...
def select_timerange(log, start_date, end_date):
    ''' Selecting only those traces starting after start_date, and ending before end_date. 
        Args: 
    ...
    if start_date:
        ...
        start_date = start_date.to_pydatetime() #dt.datetime object 
